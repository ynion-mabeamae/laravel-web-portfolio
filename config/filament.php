...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | This is the default brand name shown in the admin panel header. You can
    | override this in your panel configuration.
    |
    */

    'brand_name' => env('APP_NAME', 'Portfolio Admin'),
